...
def ask(question: Question):
    ...
    lb_Correct.setText(question.right_answer) # respuesta
...
def next_question():
    ...
    question = questions_list[window.cur_question] # toma una pregunta
...
button.clicked.connect(click_OK) # cuando se hace clic en un botón, escogemos exactamente lo que sucede 

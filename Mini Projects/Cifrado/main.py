# Diccionario que mapea las letras a números binarios
diccionario = {
...
def texto_a_binario(texto):
    """
    Convierte un texto en una cadena de binario
    """
    binario = ""
    for caracter in texto:
        if caracter in diccionario:
            binario += diccionario[caracter]
    return binario

def binario_a_texto(binario):
    """
    Convierte una cadena de binario en un texto
    """
    texto = ""
...
print("Texto cifrado en binario:", binario)

texto_descifrado = binario_a_texto(binario)

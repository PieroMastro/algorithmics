...
class Pulse1Screen(Screen):
    def __init__(self, **kwargs):
        ...
        self.counter = Seconds(total=15)
        self.counter.bind(done=self.count_finished)
        ...
        self.pulse1_input = TextInput(text='0', multiline=False, size_hint_x=1.0)
        ...
        main_layout.add_widget(inst_text)
        main_layout.add_widget(self.counter)
        main_layout.add_widget(line_1)
        main_layout.add_widget(self.button)

        self.add_widget(main_layout)

    def count_finished(self, *args):
